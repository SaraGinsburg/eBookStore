...
21. Design SignIn Screen
    1. create SigninScreen 1. create SigninScreen
    2. render email and password fields 2. render email and password fields
    3. create signin constants, actions and reducers 3. create signin constants, actions and reducers
    4. Update Header based on user login 4. Update Header based on user login
